...
echo -e "  2. ${BOLD}Faça login na sua conta:${NC} ${CYAN}commitforge login --email seu@email.com${NC}"
echo -e "     ${YELLOW}(login obrigatório para usar a CLI — ela respeita o seu plano)${NC}"
echo -e "  3. Crie commits no passado: ${CYAN}commitforge commit --repo URL --year 2020${NC}"
echo ""
echo -e "  ${YELLOW}Ainda não tem conta?${NC} Crie em ${CYAN}https://commitforge.vercel.app/login${NC}"
